...
--
-- Name: item_options; Type: TYPE; Schema: public; Owner: nanosh
--

CREATE TYPE public.item_options AS ENUM (
    'yes',
    'no',
    'maybe'
);
...
ALTER TYPE public.item_options OWNER TO nanosh;

--
-- Name: item_status; Type: TYPE; Schema: public; Owner: nanosh
--
...
ALTER TYPE public.item_status OWNER TO nanosh;
...
--
-- Name: category_list; Type: TABLE; Schema: public; Owner: nanosh
--
...
ALTER TABLE public.category_list OWNER TO nanosh;

--
-- Name: category_list_id_seq; Type: SEQUENCE; Schema: public; Owner: nanosh
--
...
--
-- Name: inventory; Type: TABLE; Schema: public; Owner: nanosh
--
...
CREATE TABLE public.inventory (
    ...
    item_is public.item_status NOT NULL,
    item_list integer NOT NULL
);


ALTER TABLE public.inventory OWNER TO nanosh;

--
-- Name: inventory_id_seq; Type: SEQUENCE; Schema: public; Owner: nanosh
--
...
--
-- Name: morkit_user; Type: TABLE; Schema: public; Owner: nanosh
--

CREATE TABLE public.morkit_user (
    id integer NOT NULL,
...
ALTER TABLE public.morkit_user OWNER TO nanosh;

--
-- Name: morkit_user_id_seq; Type: SEQUENCE; Schema: public; Owner: nanosh
--

ALTER TABLE public.morkit_user ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.morkit_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: msg; Type: TABLE; Schema: public; Owner: nanosh
--
...
CREATE TABLE public.msg (
    ...
    send_time timestamp without time zone DEFAULT now() NOT NULL,
    content text,
    buy boolean DEFAULT false NOT NULL,
    check_available boolean DEFAULT false NOT NULL,
    rsp_buy public.item_options,
    rsp_time timestamp without time zone,
    rsp_check public.item_options,
    rsp_both public.item_options,
    rsp_content text
);


ALTER TABLE public.msg OWNER TO nanosh;

--
-- Name: msg_id_seq; Type: SEQUENCE; Schema: public; Owner: nanosh
--

ALTER TABLE public.msg ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.msg_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: schemaversion; Type: TABLE; Schema: public; Owner: nanosh
--
...
ALTER TABLE public.schemaversion OWNER TO nanosh;
